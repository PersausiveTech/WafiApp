...
public class Address
{
    ...
    {
        return "ClassPojo [Email = "+Email+", address_attribute_6 = "+address_attribute_6+", Address1 = "+Address1+", CountryId = "+CountryId+", address_attribute_3 = "+address_attribute_3+", address_attribute_2 = "+address_attribute_2+", FirstName = "+FirstName+", address_attribute_5 = "+address_attribute_5+", PhoneNumber = "+PhoneNumber+", address_attribute_4 = "+address_attribute_4+", LastName = "+LastName+", address_attribute_1 = "+address_attribute_1+"]";
    }
}
