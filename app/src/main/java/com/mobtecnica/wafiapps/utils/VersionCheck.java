...
public class VersionCheck {
    ...
    public static boolean isVersionHigher(String baseVersion, String testVersion) {
        boolean isVersionHigher = versionToComparable(testVersion).compareTo(versionToComparable(baseVersion)) > 0;
        Log.d("VersionCheck","isVersionHigher : "+isVersionHigher +"   "+baseVersion + " | "+testVersion);
